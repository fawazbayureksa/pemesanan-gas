...
if (isset($_GET['action'])) {
    ...
    if ($action == 'delete' && isset($_GET['id'])) {
        ...
        $status_permintaan = 2;
        $crud->update($id, $status_permintaan);
        $_SESSION['success_message'] = "Permintaan berhasil diselesaikan!";
